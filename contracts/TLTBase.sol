...
abstract contract TLTBase is IERC721, ITimeLimitedToken {
    ...
    // @dev This is referencing the shape of the ERC721 base contract
    // so that the internal code can use ownerOf(uint256)
